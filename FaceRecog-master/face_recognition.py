...
# Creates  and initializes a database of registered users. For this we will use a simple dictionary and map each registered user with his/her face encoding.
